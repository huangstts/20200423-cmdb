...
ansible2 = MyAnsiable2(inventory='/root/gitblog/cmdb/octopus/inventory/hosts', connection='smart')

# 执行自定义任务，执行对象是 web_server 组
ansible2.run(hosts= "web_server", module="shell", args='ip a')
