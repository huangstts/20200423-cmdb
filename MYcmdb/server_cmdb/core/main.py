...
def main():
    for key,val in plugins.items():
        ...
        # print(mod_path,cls_name)      
        #等价于  mod_path=plugins.class_baseinfo   cls_name=Baseinfo   

        mod_obj=importlib.import_module(mod_path)       #用importlib下的import_module方法导入mod_path模块
                                                                                            # 等价于 import plugins.class_baseinfo  
